...
import 'package:nest/models/chats.dart' as _i30;
import 'package:nest/models/event_activity.dart' as _i29;
import 'package:nest/models/registration_model.dart' as _i28;
...
class LocationViewArguments {
  ...
  final _i28.RegistrationModel registrationModel;
...
class EventActivityViewArguments {
  ...
  final List<_i29.EventActivity> eventActivities;
...
extension NavigatorStateExtension on _i31.NavigationService {
  ...
  Future<dynamic> navigateToLocationView({
    _i27.Key? key,
    required _i28.RegistrationModel registrationModel,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToEventActivityView({
    _i27.Key? key,
    required List<_i29.EventActivity> eventActivities,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
