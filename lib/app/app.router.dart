...
import 'package:nest/models/chats.dart' as _i19;
import 'package:nest/models/event_activity.dart' as _i18;
...
class EventActivityViewArguments {
  ...
  final List<_i18.EventActivity> eventActivities;
...
extension NavigatorStateExtension on _i20.NavigationService {
  ...
  Future<dynamic> navigateToEventActivityView({
    _i17.Key? key,
    required List<_i18.EventActivity> eventActivities,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
