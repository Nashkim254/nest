...
class VideoPlayerWidget extends StackedView<FollowingViewModel> {
  ...
  @override
  Widget builder(
      BuildContext context, FollowingViewModel viewModel, Widget? child) {
  ...
  @override
  FollowingViewModel viewModelBuilder(BuildContext context) =>
      FollowingViewModel();
}
