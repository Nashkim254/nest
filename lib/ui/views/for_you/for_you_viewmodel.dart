...
class ForYouViewModel extends BaseViewModel {
  ...
  // Get posts from API (For You feed - general posts)
  Future getPosts({bool isRefresh = false}) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('For You posts loaded successfully: ${postsJson.length}',
            wrapWidth: 1024);
        debugPrint('Raw posts data: $postsJson', wrapWidth: 1024);
        ...
        debugPrint('Final filtered posts count: ${newPosts.length}');
